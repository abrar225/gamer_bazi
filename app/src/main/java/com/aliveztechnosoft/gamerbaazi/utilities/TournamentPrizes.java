...
public final class TournamentPrizes {
    ...
    private static TournamentPrizes parentInstance = null;

    // all the child instances for this class will be saved here
    public List<TournamentPrizes> allInstances = new ArrayList<>();
    ...
    @Attributes(key = "start_rank")
    public String startRank;

    @Attributes(key = "end_rank")
    public String endRank;

    @Attributes(key = "amount")
    public String amount;

    private final Map<String, TournamentPrizes> mapInstanceById = new HashMap<>();

    public TournamentPrizes(Context context) {
        if (ctx == null) {
            ctx = context.getApplicationContext();
        }
    }

    public static TournamentPrizes get(Context context, String memoryFileName) {

        if (memoryFileName.isEmpty()) {
            memoryFileName = "tournament_prizes.txt";
        }
        ...
        if (parentInstance == null || ctx == null || !memoryFileName.equals(parentInstance.memoryFileName)) {
            parentInstance = new TournamentPrizes(context);
     ...
     */
    public TournamentPrizes updateData(JSONArray jsonArray) {
     ...
     */
    public TournamentPrizes clearData() {
     ...
     */
    public TournamentPrizes appendJSONArray(JSONArray jsonArray) {
     ...
     */
    public TournamentPrizes appendJSONObject(JSONObject jsonObject) {
        final JSONArray oldJSONArray = getJSONArrayForm();
     ...
     */
    public TournamentPrizes updateSingleValue(String key, String value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public TournamentPrizes updateSingleValue(String key, int value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public TournamentPrizes updateSingleValue(String key, float value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public TournamentPrizes updateSingleValue(String key, double value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public TournamentPrizes updateSingleValue(String key, JSONObject value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public TournamentPrizes updateSingleValue(String key, JSONArray value) {
     ...
     */
    private TournamentPrizes updateValue(DataTypes dataType, String key, String strValue, int intValue, float floatValue, double doubleValue, JSONObject jsonObjectValue, JSONArray jsonArrayValue) {
    ...
    public void jsonArrayToClassObjects(JSONArray jsonArray) {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            TournamentPrizes obj;
            if (i < allInstances.size()) {
                obj = allInstances.get(i);
            } else {
                obj = new TournamentPrizes(ctx);
    ...
    public List<TournamentPrizes> getArray() {
        return allInstances;
    }
