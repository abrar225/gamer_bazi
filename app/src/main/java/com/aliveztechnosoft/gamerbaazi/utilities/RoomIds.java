...
public final class RoomIds {
    ...
    private static RoomIds parentInstance = null;

    // all the child instances for this class will be saved here
    public List<RoomIds> allInstances = new ArrayList<>();
    ...
    private final Map<String, RoomIds> mapInstanceById = new HashMap<>();

    public RoomIds(Context context) {
        if (ctx == null) {
            ctx = context.getApplicationContext();
        }
    }

    public static RoomIds get(Context context, String memoryFileName) {

        if (memoryFileName.isEmpty()) {
            memoryFileName = "room_ids.txt";
        }
        ...
        if (parentInstance == null || ctx == null || !memoryFileName.equals(parentInstance.memoryFileName)) {
            parentInstance = new RoomIds(context);
     ...
     */
    public RoomIds updateData(JSONArray jsonArray) {
     ...
     */
    public RoomIds appendJSONArray(JSONArray jsonArray) {
     ...
     */
    public RoomIds appendJSONObject(JSONObject jsonObject) {
        final JSONArray oldJSONArray = getJSONArrayForm();
     ...
     */
    public RoomIds updateSingleValue(String key, String value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public RoomIds updateSingleValue(String key, int value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public RoomIds updateSingleValue(String key, float value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public RoomIds updateSingleValue(String key, double value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public RoomIds updateSingleValue(String key, JSONObject value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public RoomIds updateSingleValue(String key, JSONArray value) {
     ...
     */
    private RoomIds updateValue(DataTypes dataType, String key, String strValue, int intValue, float floatValue, double doubleValue, JSONObject jsonObjectValue, JSONArray jsonArrayValue) {
