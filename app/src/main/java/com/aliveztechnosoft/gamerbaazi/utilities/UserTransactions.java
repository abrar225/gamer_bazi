...
public final class UserTransactions {
    ...
    private static UserTransactions parentInstance = null;

    // all the child instances for this class will be saved here
    public List<UserTransactions> allInstances = new ArrayList<>();
    ...
    @Attributes(key = "amount", dataType = DataTypes.FLOAT)
    public float amount;

    private final Map<String, UserTransactions> mapInstanceById = new HashMap<>();
    ...
    public static UserTransactions get(Context context, String memoryFileName) {

        if (memoryFileName.isEmpty()) {
            memoryFileName = "user_transactions.txt";
        }
        ...
        if (parentInstance == null || ctx == null || !memoryFileName.equals(parentInstance.memoryFileName)) {
            parentInstance = new UserTransactions(context);
     ...
     */
    public UserTransactions updateData(JSONArray jsonArray) {
     ...
     */
    public UserTransactions clearData() {
     ...
     */
    public UserTransactions appendJSONArray(JSONArray jsonArray) {
     ...
     */
    public UserTransactions appendJSONObject(JSONObject jsonObject) {
        final JSONArray oldJSONArray = getJSONArrayForm();
     ...
     */
    public UserTransactions updateSingleValue(String key, String value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public UserTransactions updateSingleValue(String key, int value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public UserTransactions updateSingleValue(String key, float value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public UserTransactions updateSingleValue(String key, double value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public UserTransactions updateSingleValue(String key, JSONObject value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public UserTransactions updateSingleValue(String key, JSONArray value) {
     ...
     */
    private UserTransactions updateValue(DataTypes dataType, String key, String strValue, int intValue, float floatValue, double doubleValue, JSONObject jsonObjectValue, JSONArray jsonArrayValue) {
    ...
    public void jsonArrayToClassObjects(JSONArray jsonArray) {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            UserTransactions obj;
            if (i < allInstances.size()) {
                obj = allInstances.get(i);
            } else {
                obj = new UserTransactions(ctx);
    ...
    public List<UserTransactions> getArray() {
        return allInstances;
    }
