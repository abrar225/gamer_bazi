...
public final class ArrayFile {
    ...
    public static ArrayFile get(Context context, String memoryFileName) {
        ...
        if (parentInstance == null || ctx == null || !memoryFileName.equals(parentInstance.memoryFileName)) {
            parentInstance = new ArrayFile(context);
     ...
     */
    public ArrayFile updateSingleValue(String key, String value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public ArrayFile updateSingleValue(String key, int value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public ArrayFile updateSingleValue(String key, float value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public ArrayFile updateSingleValue(String key, double value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public ArrayFile updateSingleValue(String key, JSONObject value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public ArrayFile updateSingleValue(String key, JSONArray value) {
     ...
     */
    private ArrayFile updateValue(DataTypes dataType, String key, String strValue, int intValue, float floatValue, double doubleValue, JSONObject jsonObjectValue, JSONArray jsonArrayValue) {
