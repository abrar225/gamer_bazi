...
public final class GamesUsername {
    ...
    public static GamesUsername get(Context context, String memoryFileName) {

        if (memoryFileName.isEmpty()) {
            memoryFileName = "games_usernames.txt";
        }
        ...
        if (parentInstance == null || ctx == null || !memoryFileName.equals(parentInstance.memoryFileName)) {
            parentInstance = new GamesUsername(context);
    ...
    public GamesUsername updateData(JSONArray jsonArray) {
        ...
        parentInstance.mapInstanceByGameId.clear();
     ...
     */
    public GamesUsername updateSingleValue(String key, String value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public GamesUsername updateSingleValue(String key, int value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public GamesUsername updateSingleValue(String key, float value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public GamesUsername updateSingleValue(String key, double value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public GamesUsername updateSingleValue(String key, JSONObject value) {
     ...
     * Update single value of one of a JSONObject (JSONObject correspondence to this class instance) in JSONArray
     */
    public GamesUsername updateSingleValue(String key, JSONArray value) {
     ...
     */
    private GamesUsername updateValue(DataTypes dataType, String key, String strValue, int intValue, float floatValue, double doubleValue, JSONObject jsonObjectValue, JSONArray jsonArrayValue) {
    ...
    public void jsonArrayToClassObjects(JSONArray jsonArray) {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            mapInstanceByGameId.put(obj.getGameId(), obj);
        }
    }
    ...
    public GamesUsername getGameUsernameByGameId(String gameId) {
        return mapInstanceByGameId.get(gameId);
    }
