...
public class BottomBar extends LinearLayout implements View.OnClickListener {
    ...
    private BottomBarTheme bottomBarTheme = BottomBar.BottomBarTheme.LIGHT;
    ...
    public void setTheme(BottomBarCustomTheme setCustomTheme) {
    ...
    private void gettingThemeValues() {
        ...
        if (bottomBarTheme == BottomBar.BottomBarTheme.LIGHT) {
            iconsColor = Color.parseColor(getColorValue(BottomBarColors.BLACK));
            bottomBarBackgroundColor = Color.parseColor(getColorValue(BottomBarColors.WHITE));
            selectedItemBackgroundColor = Color.parseColor(getColorValue(BottomBarColors.BLUE));
            selectedItemIconColor = Color.parseColor("#FFFFFF");
            selectedItemTextColor = Color.parseColor("#FFFFFF");
            textSize = 16;
        } else if (bottomBarTheme == BottomBar.BottomBarTheme.DARK) {
            iconsColor = Color.parseColor(getColorValue(BottomBarColors.WHITE));
            bottomBarBackgroundColor = Color.parseColor(getColorValue(BottomBarColors.BLACK));
            selectedItemBackgroundColor = Color.parseColor(getColorValue(BottomBarColors.ORANGE));
            selectedItemIconColor = Color.parseColor("#FFFFFF");
            selectedItemTextColor = Color.parseColor("#FFFFFF");
            textSize = 16;
        }
    ...
    private String getColorValue(BottomBarColors bottomBarColor) {

        String selectedColorValue = "";

        if (bottomBarColor == BottomBarColors.RED) {
            selectedColorValue = "#FFFF1744";
        } else if (bottomBarColor == BottomBarColors.BLACK) {
            selectedColorValue = "#000000";
        } else if (bottomBarColor == BottomBarColors.GRAY) {
            selectedColorValue = "#998A8A8A";
        } else if (bottomBarColor == BottomBarColors.ORANGE) {
            selectedColorValue = "#FF9100";
        } else if (bottomBarColor == BottomBarColors.WHITE) {
            selectedColorValue = "#FFFFFF";
        } else if (bottomBarColor == BottomBarColors.YELLOW) {
            selectedColorValue = "#FFEA00";
        } else if (bottomBarColor == BottomBarColors.DARK_RED) {
            selectedColorValue = "#FFD50000";
        } else if (bottomBarColor == BottomBarColors.LIGHT_RED) {
            selectedColorValue = "#FFFF8A80";
        } else if (bottomBarColor == BottomBarColors.DARK_ORANGE) {
            selectedColorValue = "#FFFF6D00";
        } else if (bottomBarColor == BottomBarColors.LIGHT_ORANGE) {
            selectedColorValue = "#FFFFD180";
        } else if (bottomBarColor == BottomBarColors.BLUE) {
            selectedColorValue = "#FF00B0FF";
        } else if (bottomBarColor == BottomBarColors.DARK_BLUE) {
            selectedColorValue = "#FF0091EA";
        } else if (bottomBarColor == BottomBarColors.LIGHT_BLUE) {
